insert into Student(name, birthday, student_group)
...
values
    ...
    ('Geography','You are researching world',2),('Art','You are learning history',2),
    ('PE','Doing physical excersice',3), ('Math','Working with numbers',3),
